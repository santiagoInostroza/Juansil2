...
return [
    ...
    'attributes' => [
        ...
        'price' => 'precio',
        'quantity' => 'cantidad',   
        'quantity_per_format' => 'cantidad', 
        'customer_id' => 'cliente',  
        'delivery_date' => 'fecha de entrega',
        'delivery_value' => 'valor de entrega',
        'address_id' => 'dirección',
        'payment_amount' => 'monto abonado',
        'date' => 'fecha',
        'supplier_id' => 'proveedor',
        'comparison_price' => 'precio de comparación',
        'product_format_id' => 'formato',
        'whole_sale_price' => 'precio de venta por mayor',
        'offer_price' => 'precio de oferta',
        'offer_start_date' => 'fecha de inicio de oferta',
        'offer_end_date' => 'fecha de fin de oferta',
        'discount_rate' => '% de descuento',
