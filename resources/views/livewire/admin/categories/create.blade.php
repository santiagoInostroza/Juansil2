<div class=''>
        ...
        <div class='grid gap-4 bg-white shadow p-4 rounded'>
            ...
            <div>
                <label for="">
                    <div class='py-1'>Categoría padre</div>
                    <x-selects.select :placeholder="'Selecciona Una Categoría'" :collection="$categories" wire:model="parent_id"/>
                    @error('parent_id')<span class='text-red-500 text-sm p-1'>{{ $message }}</span>@enderror
                </label>
            </div>
