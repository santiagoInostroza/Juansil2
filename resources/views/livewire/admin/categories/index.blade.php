<div class='p-4'>
    ...
    <div class='flex flex-wrap justify-between gap-4 pb-4'>
        <h1 class='text-2xl'>Categorias <i wire:loading class='fas fa-spinner animate-spin text-2xl'></i> </h1>
                                    ...
                                    <x-tables.td>
                                        <div class='flex flex-wrap gap-x-2 justify-end'>
                                            ...
                                            @can('admin.categories.destroy')
                                                <div id='dropdown_delete_{{$category->id}}' x-data='{dropdown:false}' >
                                                    <div x-on:click='dropdown=true'>
                                                        <div>
                                                    ...
                                                    <div x-show='dropdown' x-cloak >
                                                        <x-modals.alert>
                                                            ...
                                                            <x-slot name='body'>
                                                                Seguro deseas eliminar {{$category->name}}?
                                                            </x-slot>
                                                            <x-slot name='footer'>
                                                                <x-jet-danger-button wire:click='delete({{$category->id}})'>
                                                                    Eliminar
                                                                </x-jet-danger-button>
