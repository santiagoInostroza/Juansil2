<div>
    ...
    <div class='flex flex-wrap justify-between gap-4 pb-4'>
        <h1 class='text-2xl'>Proveedores <i wire:loading class='fas fa-spinner animate-spin text-2xl'></i> </h1>
                                    ...
                                    <x-tables.td>
                                        <div class='flex flex-wrap gap-x-2 justify-end'>
                                            ...
                                            @can('admin.suppliers.destroy')
                                                <div id='dropdown_delete_{{$supplier->id}}' x-data='{dropdown:false}' >
                                                    <div x-on:click='dropdown=true'>
                                                        <div>
                                                    ...
                                                    <div x-show='dropdown' x-cloak >
                                                        <x-modals.alert>
                                                            ...
                                                            <x-slot name='body'>
                                                                Seguro deseas eliminar {{$supplier->name}}?
                                                            </x-slot>
                                                            <x-slot name='footer'>
                                                                <x-jet-danger-button wire:click='delete({{$supplier->id}})'>
                                                                    Eliminar
                                                                </x-jet-danger-button>
